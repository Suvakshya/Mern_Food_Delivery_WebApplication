    ...
    <div className="bg-gradient-to-b from-[#1a1212] to-[#2a1e1e] text-white py-16 px-6 sm:px-12 lg:px-24 font-[Poppins]">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-5 transform transition-all bg-gradient-to-r from-amber-400 to-orange-400 bg-clip-text text-transparent font-[Playfair_Display] italic">
            <span className="font-cursive text-5xl md:text-7xl sm:text-6xl mb-2">
              Our Exquisite Menu
            </span>
            <br />
            <span className="text-amber-300 text-2xl sm:text-3xl opacity-90 font-light block mt-2 relative z-10">
        ...
        <div className="flex justify-center mt-16">
          <Link 
            to="/menu" 
            onClick={scrollToTop}
            className="px-8 py-3 bg-gradient-to-r from-amber-500 to-orange-600 rounded-xl font-bold hover:scale-[1.02] transition-transform duration-300 flex items-center gap-3 shadow-xl hover:shadow-amber-500/20 group relative overflow-hidden"
          >
