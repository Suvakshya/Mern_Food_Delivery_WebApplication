...
const API_URL = "https://mern-food-delivery-webapplication-backend.onrender.com";
          ...
          <>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {cartItems.map(({ _id, item, quantity }) => (
                ...
                >
                  <div
                    className="w-24 h-24 flex-shrink-0 cursor-pointer relative overflow-hidden rotate-12 transition-transform duration-300"
            ...
            <div className="mt-12 pt-8 border-t border-amber-800/30 animate-fade-in-up">
              <div className="flex flex-col sm:flex-row justify-between items-center gap-8">
                <Link
                  to="/menu"
                  className="bg-amber-800/50 px-8 py-3 rounded-full font-cinzel uppercase tracking-wider hover:bg-amber-800/50 transition-all duration-300 text-amber-100 inline-flex items-center gap-2 hover:gap-3 active:scale-95"
                >
                  Continue Shopping
                </Link>
                ...
                <div className="flex items-center gap-8">
                  ...
                  <Link to='/checkout' className="bg-amber-800/50 px-8 py-3 rounded-full font-cinzel uppercase tracking-wider hover:bg-amber-800/50 transition-all duration-300 text-amber-100 flex items-center gap-2 active:scale-95">
                    Checkout Now
                  </Link>
                </div>
              </div>
